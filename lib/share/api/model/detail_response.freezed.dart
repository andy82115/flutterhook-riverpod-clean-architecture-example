...
mixin _$DetailResponse {
  ...
  @JsonKey(name: "owner")
  Organization? get owner => throw _privateConstructorUsedError;
  ...
  CustomProperties? get customProperties => throw _privateConstructorUsedError;
...
abstract class $DetailResponseCopyWith<$Res> {
  ...
  $OrganizationCopyWith<$Res>? get owner;
  $LicenseCopyWith<$Res>? get license;
  $PermissionsCopyWith<$Res>? get permissions;
  $CustomPropertiesCopyWith<$Res>? get customProperties;
...
class _$DetailResponseCopyWithImpl<$Res, $Val extends DetailResponse>
  ...
  $OrganizationCopyWith<$Res>? get owner {
    ...
    return $OrganizationCopyWith<$Res>(_value.owner!, (value) {
  ...
  $CustomPropertiesCopyWith<$Res>? get customProperties {
    ...
    return $CustomPropertiesCopyWith<$Res>(_value.customProperties!, (value) {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.customProperties, customProperties) || other.customProperties == customProperties) &&
...
abstract class _DetailResponse implements DetailResponse {
  const factory _DetailResponse(
          ...
          @JsonKey(name: "owner") final Organization? owner,
  ...
  @override
  @JsonKey(name: "custom_properties")
  CustomProperties? get customProperties;
  @override
  @JsonKey(name: "organization")
...
CustomProperties _$CustomPropertiesFromJson(Map<String, dynamic> json) {
  return _CustomProperties.fromJson(json);
}

/// @nodoc
mixin _$CustomProperties {
  /// Serializes this CustomProperties to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CustomPropertiesCopyWith<$Res> {
  factory $CustomPropertiesCopyWith(
          CustomProperties value, $Res Function(CustomProperties) then) =
      _$CustomPropertiesCopyWithImpl<$Res, CustomProperties>;
}

/// @nodoc
class _$CustomPropertiesCopyWithImpl<$Res, $Val extends CustomProperties>
    implements $CustomPropertiesCopyWith<$Res> {
  _$CustomPropertiesCopyWithImpl(this._value, this._then);
  ...
  /// Create a copy of CustomProperties
  /// with the given fields replaced by the non-null parameter values.
}

/// @nodoc
abstract class _$$CustomPropertiesImplCopyWith<$Res> {
  factory _$$CustomPropertiesImplCopyWith(_$CustomPropertiesImpl value,
          $Res Function(_$CustomPropertiesImpl) then) =
      __$$CustomPropertiesImplCopyWithImpl<$Res>;
}

/// @nodoc
class __$$CustomPropertiesImplCopyWithImpl<$Res>
    extends _$CustomPropertiesCopyWithImpl<$Res, _$CustomPropertiesImpl>
    implements _$$CustomPropertiesImplCopyWith<$Res> {
  __$$CustomPropertiesImplCopyWithImpl(_$CustomPropertiesImpl _value,
      $Res Function(_$CustomPropertiesImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$CustomPropertiesImpl implements _CustomProperties {
  const _$CustomPropertiesImpl();

  factory _$CustomPropertiesImpl.fromJson(Map<String, dynamic> json) =>
      _$$CustomPropertiesImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$CustomPropertiesImpl);
  }
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$CustomPropertiesImplToJson(
      this,
    );
  }
}

abstract class _CustomProperties implements CustomProperties {
  const factory _CustomProperties() = _$CustomPropertiesImpl;

  factory _CustomProperties.fromJson(Map<String, dynamic> json) =
      _$CustomPropertiesImpl.fromJson;
}
...
abstract class _Organization implements Organization {
  const factory _Organization(
      ...
      @JsonKey(name: "site_admin") final bool? siteAdmin}) = _$OrganizationImpl;
...
class _$PermissionsImpl implements _Permissions {
  const _$PermissionsImpl(
      ...
      @JsonKey(name: "maintain") this.maintain,
      @JsonKey(name: "push") this.push,
      @JsonKey(name: "triage") this.triage,
      @JsonKey(name: "pull") this.pull});
...
abstract class _Permissions implements Permissions {
  const factory _Permissions(
      ...
      @JsonKey(name: "maintain") final bool? maintain,
      @JsonKey(name: "push") final bool? push,
      @JsonKey(name: "triage") final bool? triage,
      @JsonKey(name: "pull") final bool? pull}) = _$PermissionsImpl;
